package com.wjw.core.utils.other.string;

import com.wjw.core.utils.other.collection.CollectionUtils;
import com.wjw.core.utils.other.object.ObjectUtils;
...
public abstract class StringUtils {
  ...
  public static boolean hasText(String str) {
    return hasLength(str) && hasText((CharSequence) str);
  }
  ...
  public static String[] delimitedListToStringArray(String str, String delimiter,
    ...
    if (str == null) {
      ...
      if ("".equals(delimiter)) {
        ...
        int delPos;
        for (pos = 0; (delPos = str.indexOf(delimiter, pos)) != -1;
